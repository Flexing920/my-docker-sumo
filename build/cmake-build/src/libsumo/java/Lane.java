...
public class Lane {
  ...
  public static SWIGTYPE_p_std__vectorT_libsumo__TraCIConnection_t getLinks(String laneID) {
    return new SWIGTYPE_p_std__vectorT_libsumo__TraCIConnection_t(libsumoJNI.Lane_getLinks(laneID), true);
  }
  ...
  public static void setAllowed(String laneID, String allowedClass) {
    libsumoJNI.Lane_setAllowed__SWIG_0(laneID, allowedClass);
  }
  ...
  public static SWIGTYPE_p_std__pairT_std__string_std__string_t getParameterWithKey(String objectID, String key) {
    return new SWIGTYPE_p_std__pairT_std__string_std__string_t(libsumoJNI.Lane_getParameterWithKey(objectID, key), true);
  }
  ...
  public static void subscribe(String objectID, IntVector varIDs, double begin, double end) {
    libsumoJNI.Lane_subscribe__SWIG_0(objectID, IntVector.getCPtr(varIDs), varIDs, begin, end);
  }

  public static void subscribe(String objectID, IntVector varIDs, double begin) {
    libsumoJNI.Lane_subscribe__SWIG_1(objectID, IntVector.getCPtr(varIDs), varIDs, begin);
  }

  public static void subscribe(String objectID, IntVector varIDs) {
    libsumoJNI.Lane_subscribe__SWIG_2(objectID, IntVector.getCPtr(varIDs), varIDs);
  }

  public static void subscribe(String objectID) {
    libsumoJNI.Lane_subscribe__SWIG_3(objectID);
  }
  ...
  public static void subscribeContext(String objectID, int domain, double dist, IntVector varIDs, double begin, double end) {
    libsumoJNI.Lane_subscribeContext__SWIG_0(objectID, domain, dist, IntVector.getCPtr(varIDs), varIDs, begin, end);
  }

  public static void subscribeContext(String objectID, int domain, double dist, IntVector varIDs, double begin) {
    libsumoJNI.Lane_subscribeContext__SWIG_1(objectID, domain, dist, IntVector.getCPtr(varIDs), varIDs, begin);
  }

  public static void subscribeContext(String objectID, int domain, double dist, IntVector varIDs) {
    libsumoJNI.Lane_subscribeContext__SWIG_2(objectID, domain, dist, IntVector.getCPtr(varIDs), varIDs);
  }

  public static void subscribeContext(String objectID, int domain, double dist) {
    libsumoJNI.Lane_subscribeContext__SWIG_3(objectID, domain, dist);
  }
  ...
  public static SWIGTYPE_p_std__mapT_int_std__shared_ptrT_libsumo__TraCIResult_t_t getSubscriptionResults(String objectID) {
    return new SWIGTYPE_p_std__mapT_int_std__shared_ptrT_libsumo__TraCIResult_t_t(libsumoJNI.Lane_getSubscriptionResults(objectID), true);
  }
  ...
  public static SWIGTYPE_p_std__mapT_std__string_std__mapT_int_std__shared_ptrT_libsumo__TraCIResult_t_t_t getContextSubscriptionResults(String objectID) {
    return new SWIGTYPE_p_std__mapT_std__string_std__mapT_int_std__shared_ptrT_libsumo__TraCIResult_t_t_t(libsumoJNI.Lane_getContextSubscriptionResults(objectID), true);
  }
