...
def route_setParameter(routeID, param, value):
    return _libsumo.route_setParameter(routeID, param, value)
...
def simulation_getBusStopWaitingIDList(id):
    return _libsumo.simulation_getBusStopWaitingIDList(id)
...
def vehicle_getNextStops(vehicleID, limit=0):
    return _libsumo.vehicle_getNextStops(vehicleID, limit)
...
def vehicle_getParameter(vehicleID, param):
    return _libsumo.vehicle_getParameter(vehicleID, param)
...
def vehicle_setParameter(vehicleID, param, value):
    return _libsumo.vehicle_setParameter(vehicleID, param, value)
...
def person_getParameter(personID, param):
    return _libsumo.person_getParameter(personID, param)
...
def person_setParameter(personID, param, value):
    return _libsumo.person_setParameter(personID, param, value)
...
def calibrator_getParameter(calibratorID, param):
    return _libsumo.calibrator_getParameter(calibratorID, param)
...
def calibrator_setParameter(calibratorID, key, value):
    return _libsumo.calibrator_setParameter(calibratorID, key, value)
...
def busstop_getParameter(stopID, param):
    return _libsumo.busstop_getParameter(stopID, param)
...
def busstop_setParameter(stopID, key, value):
    return _libsumo.busstop_setParameter(stopID, key, value)
...
def parkingarea_getParameter(stopID, param):
    return _libsumo.parkingarea_getParameter(stopID, param)
...
def parkingarea_setParameter(stopID, key, value):
    return _libsumo.parkingarea_setParameter(stopID, key, value)
...
def chargingstation_getParameter(stopID, param):
    return _libsumo.chargingstation_getParameter(stopID, param)
...
def chargingstation_setParameter(stopID, key, value):
    return _libsumo.chargingstation_setParameter(stopID, key, value)
...
def overheadwire_getParameter(stopID, param):
    return _libsumo.overheadwire_getParameter(stopID, param)
...
def overheadwire_setParameter(stopID, key, value):
    return _libsumo.overheadwire_setParameter(stopID, key, value)
